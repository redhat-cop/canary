# amf-application-signature-ibm-websphere-mq-everyplace
An Ansible Role that identifies an IBM WebSphere MQ Everyplace server as part of the Ansible Migration Factory Discovery process.
