# amf-application-signature-ibm-cognos-analytics
An Ansible Role that identifies an IBM Cognos Analytics server as part of the Ansible Migration Factory Discovery process.
