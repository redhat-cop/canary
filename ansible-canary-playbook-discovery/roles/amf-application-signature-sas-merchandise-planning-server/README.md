# amf-application-signature-sas-merchandise-planning-server
An Ansible Role that identifies an SAS Merchandise Planning server as part of the Ansible Migration Factory Discovery process.
