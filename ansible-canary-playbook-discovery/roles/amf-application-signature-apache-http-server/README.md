# amf-application-signature-apache-http-server
An Ansible Role that identifies an Apache HTTP server server as part of the Ansible Migration Factory Discovery process.
