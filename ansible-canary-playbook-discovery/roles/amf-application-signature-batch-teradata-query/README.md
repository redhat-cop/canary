# amf-application-signature-batch-teradata-query
An Ansible Role that identifies an Batch Teradata Query server as part of the Ansible Migration Factory Discovery process.
