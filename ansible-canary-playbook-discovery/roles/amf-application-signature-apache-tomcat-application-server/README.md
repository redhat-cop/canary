# amf-application-signature-apache-tomcat-application-server
An Ansible Role that identifies an Apache Tomcat Application server as part of the Ansible Migration Factory Discovery process.
