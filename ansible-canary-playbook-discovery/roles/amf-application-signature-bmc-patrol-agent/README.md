# amf-application-signature-bmc-patrol-agent
An Ansible Role that identifies an BMC Patrol Agent server as part of the Ansible Migration Factory Discovery process.
