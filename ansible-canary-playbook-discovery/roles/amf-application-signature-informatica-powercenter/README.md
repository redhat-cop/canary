# amf-application-signature-informatica-powercenter
An Ansible Role that identifies an Informatica PowerCenter server as part of the Ansible Migration Factory Discovery process.
