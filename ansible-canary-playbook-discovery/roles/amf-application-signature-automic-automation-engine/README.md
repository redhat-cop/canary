# amf-application-signature-automic-automation-engine
An Ansible Role that identifies an Automic Automation Engine server as part of the Ansible Migration Factory Discovery process.
