# amf-application-signature-opti-flow-mgr
An Ansible Role that identifies an OptiFlowMgr server as part of the Ansible Migration Factory Discovery process.
