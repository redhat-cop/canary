# amf-application-signature-ibm-db2-database-server
An Ansible Role that identifies an IBM DB2 Database server as part of the Ansible Migration Factory Discovery process.
