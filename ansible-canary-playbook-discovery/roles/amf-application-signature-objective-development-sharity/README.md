# amf-application-signature-objective-development-sharity
An Ansible Role that identifies an Objective Development Sharity server as part of the Ansible Migration Factory Discovery process.
