# amf-application-signature-ibm-infosphere-datastage
An Ansible Role that identifies an IBM InfoSphere DataStage server as part of the Ansible Migration Factory Discovery process.
