# amf-application-signature-ibm-cognos-business-intelligence
An Ansible Role that identifies an IBM Cognos Business Intelligence server as part of the Ansible Migration Factory Discovery process.
