# amf-application-signature-ibm-websphere-application-server
An Ansible Role that identifies an IBM WebSphere Application server as part of the Ansible Migration Factory Discovery process.
