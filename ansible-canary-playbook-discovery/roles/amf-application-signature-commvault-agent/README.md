# amf-application-signature-commvault-agent
An Ansible Role that identifies an Commvault Agent server as part of the Ansible Migration Factory Discovery process.
