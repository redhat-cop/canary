# amf-application-signature-ibm-rational-clearcase
An Ansible Role that identifies an IBM Rational ClearCase server as part of the Ansible Migration Factory Discovery process.
