# amf-application-signature-microstrategy-intelligence-server
An Ansible Role that identifies an MicroStrategy Intelligence server as part of the Ansible Migration Factory Discovery process.
