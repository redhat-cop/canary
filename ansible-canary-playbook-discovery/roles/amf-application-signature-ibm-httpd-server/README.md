# amf-application-signature-ibm-httpd-server
An Ansible Role that identifies an BM HTTPD server as part of the Ansible Migration Factory Discovery process.
