# amf-application-signature-ibm-tsm-backup-client
An Ansible Role that identifies an IBM TSM Backup client server as part of the Ansible Migration Factory Discovery process.
