# amf-application-signature-opswise-universal-agent
An Ansible Role that identifies an Opswise Universal Agent  server as part of the Ansible Migration Factory Discovery process.
